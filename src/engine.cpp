...
Engine::Engine() {
  ...
  setupText(&titleText, mainFont, "JAKE MADE THIS", 28, Color::Blue);
  ...
  setupText(&gameOverText, mainFont, "UR TRASH KID", 72, Color::Yellow);
  ...
  setupText(&pressEnterText, mainFont, "Press ENTER ", 38, Color::Red);
